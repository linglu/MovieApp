...
import com.linky.movieapp.utils.ImageLoaderUtils;
...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setVerticalRecycler(int viewId, CommonRecycleViewAdapter adapter) {
    ...
    public ViewHolderHelper setImageUrl(int viewId, String url, int ic_default_pic) {
//        ImageView view = getView(viewId);
        PhotoView view = getView(viewId);
        ImageLoaderUtils.display(mContext, view, url, ic_default_pic);
        return this;
    }

    public ViewHolderHelper setImageUrl(int viewId, String url, int ic_default_pic, int ic_error_pic) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.display(mContext, view, url, ic_default_pic, ic_error_pic);
        return this;
    }
...
//    }
    ...
    public ViewHolderHelper setTextColor(int viewId, @ColorRes int textColorRes) {
     ...
     * 关于事件的
     */
    public ViewHolderHelper setOnClickListener(
            View.OnClickListener listener, @NonNull int... viewId) {
        if(viewId.length == 0){
            throw new NullPointerException("viewId can not null,please check for you setOnClickListener method");
        }
        View view;
        for (int i : viewId) {
            view = getView(i);
